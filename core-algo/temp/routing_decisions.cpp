...
(
    ...
    std::vector< std::vector<int> > client_clusters = cluster_vertices(clients_to_visit, num_clusters);
    std::vector< std::pair<double, double> > centers = find_clusters_centers(client_clusters);
